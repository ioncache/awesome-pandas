...
~~~sh
git clone git@github.com:nko3/awesome-pandas.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-awesome-pandas --password CT5CGifEsMlVcS9/
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/awesome-pandas" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280627
